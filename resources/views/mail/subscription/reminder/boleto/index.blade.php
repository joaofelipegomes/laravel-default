        ...
        <div class="s-logo">
          ...
          <div>
            <div class="signature-body">
              ...
              <p>
                Conforme o acordo de prestação de serviços firmado entre nós, o pagamento da mensalidade
                no valor de R$ {{ moneyFormat($amount) }} deve ser efetuado até o dia {{ $duedate }}
              ...
              <p>
                Lembramos que você pode efetuar o pagamento copiando o código ou clicando em visualizar boleto.
              </p>
              ...
              <div class="button-subscription-container">
                ...
                <div>
                  <a class="button-subscription" href="{{ $boleto_url }}">Visualizar boleto</a>
                </div>
              </div>
